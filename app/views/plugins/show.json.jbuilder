json.extract! @plugin, :id, :name, :author, :description, :version, :category
...
json.links @plugin.plugin_links do |link|
  json.extract! link, :name, :url
end

json.set! :created_at, @plugin.created_at.to_formatted_s(:long)
json.set! :updated_at, @plugin.updated_at.to_formatted_s(:long)
