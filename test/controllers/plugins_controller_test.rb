...
class PluginsControllerTest < ActionController::TestCase
  ...
  test "should create plugin" do
    assert_difference('Plugin.count') do
      post :create, plugin: { author: @plugin.author, description: @plugin.description, name: @plugin.name, version: @plugin.version }
    end
  ...
  test "should update plugin" do
    patch :update, id: @plugin, plugin: { author: @plugin.author, description: @plugin.description, name: @plugin.name, version: @plugin.version }
    assert_redirected_to plugin_path(assigns(:plugin))
  end
